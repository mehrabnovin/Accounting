...
namespace Novin {
    ...
    public partial class AccountingDataSet6 : global::System.Data.DataSet {
        ...
        public partial class tbl_EmployeeDataTable : global::System.Data.TypedTableBase<tbl_EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public tbl_EmployeeRow Addtbl_EmployeeRow(int ID, string FirstName, string LastName, string state) {
...
namespace Novin.AccountingDataSet6TableAdapters {
    ...
    public partial class tbl_EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `tbl_Employee` WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL)" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `tbl_Employee` (`ID`, `FirstName`, `LastName`, `state`) VALUES (?, ?," +
                " ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `tbl_Employee` SET `ID` = ?, `FirstName` = ?, `LastName` = ?, `state` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `state` IS NULL) OR (`state` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, state FROM tbl_Employee";
        ...
        public virtual int Fill(AccountingDataSet6.tbl_EmployeeDataTable dataTable) {
        ...
        public virtual AccountingDataSet6.tbl_EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AccountingDataSet6.tbl_EmployeeDataTable dataTable = new AccountingDataSet6.tbl_EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AccountingDataSet6.tbl_EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_FirstName, string Original_LastName, string Original_state) {
        ...
        public virtual int Insert(int ID, string FirstName, string LastName, string state) {
        ...
        public virtual int Update(int ID, string FirstName, string LastName, string state, int Original_ID, string Original_FirstName, string Original_LastName, string Original_state) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string state, int Original_ID, string Original_FirstName, string Original_LastName, string Original_state) {
            return this.Update(Original_ID, FirstName, LastName, state, Original_ID, Original_FirstName, Original_LastName, Original_state);
        }
    }
        ...
        public virtual int UpdateAll(AccountingDataSet6 dataSet) {
            ...
            try {
                ...
                if ((this._tbl_EmployeeTableAdapter != null)) {
                    ...
                    this._tbl_EmployeeTableAdapter.Connection = ((global::System.Data.OleDb.OleDbConnection)(workConnection));
                    this._tbl_EmployeeTableAdapter.Transaction = ((global::System.Data.OleDb.OleDbTransaction)(workTransaction));
                ...
                if ((this._tbl_EmployeeTableAdapter != null)) {
                    this._tbl_EmployeeTableAdapter.Connection = ((global::System.Data.OleDb.OleDbConnection)(revertConnections[this._tbl_EmployeeTableAdapter]));
